# Acuario Pablo´s
Este es un proyecto de ecommerce básico. La aplicación permite ver una lista de productos de Acuario y realizar compras en línea. Los productos y las órdenes de compra se almacenan en Firebase.
